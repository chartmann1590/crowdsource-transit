/**
 * CrowdTransit walking-directions proxy.
 *
 ...
 * POST /walk to ORS foot-walking GeoJSON directions with request validation so the
 * endpoint can't be used as a general ORS relay.
 */
